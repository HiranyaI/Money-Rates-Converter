...
w=" " #--->User option "word representation"
c=0 #--->User option "USD currency"
output=" " 
conversion=" "
need_to_continue=" " 
valid_amount=" "
...
while( need_to_continue=="Yes" ):
    ...
    #--- Get the amount ---
    amount=int(input("Please enter your amount less than Rs.100,000 without decimals: Rs.")) 
...
#--- Continue if needed ---
    try_again = input("Do you want to try again?(If you'd like to try again, please type 'y'/If you don't like to try again, please type 'n'):")
    if try_again == "y":
        continue
    elif try_again == "n":
        break
